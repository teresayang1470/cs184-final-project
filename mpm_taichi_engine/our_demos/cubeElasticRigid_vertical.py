...
mpm.add_cube(lower_corner=[0.25, 0.0], cube_size=[0.5, 0.1], material=MPMSolver.material_rigid, color=0xFFFF00, sample_density=25)
mpm.add_cube(lower_corner=[0.4, 0.8], cube_size=[0.1, 0.1], material=MPMSolver.material_elastic, color=0xED553B, sample_density=25)
