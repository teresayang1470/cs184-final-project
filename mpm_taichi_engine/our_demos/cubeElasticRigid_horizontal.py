...
mpm.add_cube(lower_corner=[0.2, 0.5], cube_size=[0.1, 0.1], material=MPMSolver.material_elastic, color=0xED553B, velocity=[3, 0], sample_density=25)
mpm.add_cube(lower_corner=[0.8, 0.5], cube_size=[0.1, 0.1], material=MPMSolver.material_rigid, color=0xFFFF00, velocity=[-3, 0], sample_density=25)
