...
mpm.add_ellipsoid(center=[0.5, 0.5], radius=0.1, material=MPMSolver.material_bread, color=0x8B4513)
...
mpm.add_ellipsoid(center=[0.8, 0.8], radius=0.05, material=MPMSolver.material_snow, color=0xEEEEF0, velocity=[-3, -3])
