...
for frame in range(200):
    mpm.step(8e-3)
    if 10 < frame < 200:
        mpm.add_cube(lower_corner=[0.3, 0.7], cube_size=[0.2, 0.01],  material = MPMSolver.material_confetti, color = 0x068587, velocity=[math.sin(frame * 0.1), 0], sample_density = 0.5)
